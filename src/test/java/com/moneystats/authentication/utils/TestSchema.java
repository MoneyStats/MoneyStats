...
public class TestSchema {
    ...
    public static final String ROLE_USER_PASS_HASHED =
            bCryptPasswordEncoder.encode(ROLE_USER_PASSWORD);
    ...
    public static final AuthCredentialToUpdateDTO AUTH_CREDENTIAL_TO_UPDATE_DTO = new AuthCredentialToUpdateDTO(FIRSTNAME, LASTNAME, DATE_OF_BIRTH, EMAIL, ROLE_USER_USERNAME);
}
